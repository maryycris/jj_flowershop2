    ...
    <div id="app">
        ...
        <nav class="clerk-navbar-bg">
            <div class="clerk-navbar-content">
                ...
                <div class="clerk-user dropdown">
                    <a href="#" class="d-flex align-items-center gap-2 text-white text-decoration-none dropdown-toggle" id="clerkProfileDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="cursor:pointer;">
                        ...
                        <?php endif; ?>
                        <?php echo e(Auth::user()->name ?? 'CLERK'); ?>

                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="clerkProfileDropdown">
                        <li><a class="dropdown-item" href="<?php echo e(route('clerk.profile.edit')); ?>">My Profile</a></li>
            ...
            <div class="clerk-navbar-links">
                <a href="<?php echo e(route('clerk.product_catalog.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.product_catalog.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-grid"></i>
                    <span>Product catalog</span>
                </a>
                <a href="<?php echo e(route('clerk.customize.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.customize.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-brush"></i>
                    <span>Customize</span>
                </a>
                <a href="<?php echo e(route('clerk.events.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.events.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-calendar-event"></i>
                    <span>Event</span>
                </a>
                <a href="<?php echo e(route('clerk.inventory.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.inventory.index')): ?> active <?php endif; ?>">
                    <i class="bi bi-clipboard"></i>
                    <span>Inventory</span>
                </a>
                <a href="<?php echo e(route('clerk.orders.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.orders.*')): ?> active <?php endif; ?>">
                    <i class="bi bi-cart"></i>
                    <span>Sales Orders</span>
                </a>
                <a href="<?php echo e(route('clerk.invoices.index')); ?>" class="clerk-navbar-link <?php if(request()->routeIs('clerk.invoices.*')): ?> active <?php endif; ?>">
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/layouts/clerk_app.blade.php ENDPATH**/ ?>