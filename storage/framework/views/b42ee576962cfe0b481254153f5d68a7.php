            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    <div class="p-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e6f0e6;">
                        <a href="<?php echo e(route('admin.orders.walkin.quotation', $order->id)); ?>" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center justify-content-center" title="Back" aria-label="Back" style="width:34px;height:34px;padding:0;">
                        ...
                        <div class="ms-auto d-flex align-items-center gap-3">
                            ...
                            <a href="<?php echo e(route('admin.orders.walkin.validate', $order->id)); ?>" class="btn btn-success">Send Invoice</a>
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/orders/walkin/create_invoice.blade.php ENDPATH**/ ?>