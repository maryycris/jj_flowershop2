                ...
                <div class="bg-white rounded-3 p-4 mb-4" style="box-shadow: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" style="min-height: 120px;">
                            <option><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?>\nBang-bang Cordova\nCebu City\n+<?php echo e(Auth::user()->contact_number); ?>\nRegion VII</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-3 p-4 mb-4" style="box-shadow: none;">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <input type="text" class="form-control form-control-sm text-center quantity-input" value="<?php echo e($item->quantity); ?>" readonly style="width: 40px;">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span style="color: #222;">₱<span id="shippingFeeDisplay"><?php echo e(number_format($shippingFee ?? 50, 2)); ?></span></span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between mb-3">
                        <span style="font-weight: 600;">Total</span>
                        <span style="color: #7bb47b; font-weight: 600; font-size: 1.15rem;">₱<span id="cartTotalFinal"><?php echo e(number_format($subtotal + ($shippingFee ?? 50), 2)); ?></span></span>
                    </div>
