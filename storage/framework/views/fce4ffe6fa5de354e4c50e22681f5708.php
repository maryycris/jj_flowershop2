            ...
            <form action="<?php echo e(route('admin.orders.store')); ?>" method="POST">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <select class="form-select" id="order_method_top" style="width: 160px;" onchange="if(this.value==='delivery'){window.location='<?php echo e(route('admin.orders.walkin.delivery')); ?>';}">
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/orders/create.blade.php ENDPATH**/ ?>