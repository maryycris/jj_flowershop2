                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="<?php echo e(route('admin.events.show', $event)); ?>" class="btn btn-sm btn-outline-primary" title="View Details">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <div class="btn-group" role="group">
                                    ...
                                    <a href="<?php echo e(route('admin.events.invoice.view', $event->id)); ?>" class="btn btn-sm btn-outline-secondary" target="_blank" title="View Invoice">
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/events/index.blade.php ENDPATH**/ ?>