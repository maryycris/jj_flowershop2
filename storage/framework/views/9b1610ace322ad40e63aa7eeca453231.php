        ...
        <div class="modal-content" style="background: #f8faf8;">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="street_address" value="<?php echo e(Auth::user()->street_address ?? ''); ?>" required>
                </div>
                <div class="mb-3">
                        <label class="form-label">Barangay *</label>
                        <input type="text" class="form-control" name="barangay" value="<?php echo e(Auth::user()->barangay ?? ''); ?>" required>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <label class="form-label">Municipality *</label>
                            <input type="text" class="form-control" name="municipality" value="<?php echo e(Auth::user()->municipality ?? ''); ?>" required>
                        </div>
                        <div class="col">
