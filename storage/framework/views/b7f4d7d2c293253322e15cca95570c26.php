                ...
                <div class="d-flex justify-content-between" style="align-items: flex-start;">
                    ...
                    <div class="d-flex flex-column flex-grow-1" style="max-width: 1000px; margin: 0 20px;">
                        ...
                        <div class="d-flex align-items-center justify-content-end gap-4 customer-right-icons">
                            ...
                            <button class="icon-btn text-white position-relative <?php if(request()->routeIs('customer.chat.*')): ?> active <?php endif; ?>" id="navbarChatBtn" title="Chat Support" style="background: none; border: none; font-size: 1.35rem; padding: 0 .5rem 0 0;"><i class="bi bi-chat-dots"></i></button>
                        </div>
                    </div>
                </div>
            </div>
