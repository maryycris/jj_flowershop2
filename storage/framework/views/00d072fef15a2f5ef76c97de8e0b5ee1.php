    ...
    <div class="register-card">
        ...
        <form method="POST" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control form-control-sm" placeholder="First Name" value="<?php echo e(old('first_name')); ?>" required autofocus oninput="this.value = this.value.replace(/^\s+/, '')">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="last_name" id="last_name" class="form-control form-control-sm" placeholder="Last Name" value="<?php echo e(old('last_name')); ?>" required oninput="this.value = this.value.replace(/^\s+/, '')">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="contact_number" id="contact_number" class="form-control form-control-sm"
                       placeholder="Phone Number" value="<?php echo e(old('contact_number')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="verification-channel-group" class="mb-2" style="display:none;">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="verification_channel" id="channel_email" value="email" <?php echo e(old('verification_channel') == 'email' ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="channel_email">Gmail</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="verification_channel" id="channel_phone" value="phone" <?php echo e(old('verification_channel') == 'phone' ? 'checked' : ''); ?>>
                    <label class="form-check-label" for="channel_phone">Phone Number</label>
                </div>
                <?php if($errors->has('verification_channel')): ?>
                    <span class="text-danger" role="alert"><?php echo e($errors->first('verification_channel')); ?></span>
                <?php endif; ?>
            </div>
            <div id="at-least-one-error" class="text-danger mb-2" style="display:none; font-size:0.95rem;"></div>
            <?php if($errors->has('at_least_one')): ?>
                <div class="text-danger mb-2" style="font-size:0.95rem;"><?php echo e($errors->first('at_least_one')); ?></div>
            <?php endif; ?>
            <div class="mb-2">
