...
<body>
    ...
    <div class="driver-menu shadow" id="driverMenu">
        ...
        <ul class="nav flex-column px-3">
            <li class="nav-item mb-2"><a href="<?php echo e(route('driver.dashboard')); ?>" class="nav-link">Dashboard</a></li>
            <li class="nav-item mb-2"><a href="<?php echo e(route('driver.orders.index')); ?>" class="nav-link">Orders</a></li>
            <li class="nav-item mb-2"><a href="<?php echo e(route('driver.history.index')); ?>" class="nav-link">Delivery History</a></li>
            <li class="nav-item mb-2"><a href="<?php echo e(route('driver.profile')); ?>" class="nav-link">My Profile</a></li>
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/layouts/driver_mobile.blade.php ENDPATH**/ ?>