...
<form method="POST" action="<?php echo e(route('clerk.orders.online.validate.confirm', $order)); ?>" class="d-none" id="validateForm">
    <?php echo csrf_field(); ?>
</form>
...
<?php echo $__env->make('layouts.clerk_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/clerk/orders/online/validate.blade.php ENDPATH**/ ?>