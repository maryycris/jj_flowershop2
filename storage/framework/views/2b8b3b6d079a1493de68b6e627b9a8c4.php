...
<head>
    ...
    <style>
        ...
        .navbar-admin { background-color: #5E8458; height: 70px; border-bottom: none; width: 100vw; margin-left: calc(50% - 50vw); margin-right: calc(50% - 50vw); }
        ...
        .navbar-admin-links-row { width: 100vw; margin-left: calc(50% - 50vw); margin-right: calc(50% - 50vw); background: #5E8458; }
    ...
    <div class="sidebar-container sidebar-clean d-flex flex-column align-items-center py-4" style="background: #F6FBF4; min-width: 220px; max-width: 260px; height: 100vh; ">
        ...
        <nav class="w-100">
            <ul class="nav flex-column align-items-center align-items-md-start w-100">
                ...
                <li class="nav-item w-100 mb-1">
                    <a href="<?php echo e(route('admin.reports.inventory')); ?>" class="sidebar-link <?php if(request()->routeIs('admin.reports.inventory')): ?> active <?php endif; ?>">Inventory Reports</a>
                </li>
                <li class="nav-item w-100 mb-1">
