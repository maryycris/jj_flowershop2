        ...
        <div class="col-12 col-xl-10 px-3 px-md-0">
            <div class="card shadow-lg border-0" style="border-radius: 20px; background: #fefefe;">
                <div class="card-body p-3 p-md-4 p-lg-5">
                    <form action="<?php echo e(route('customer.events.store')); ?>" method="POST" id="eventBookingForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/customer/events/book.blade.php ENDPATH**/ ?>