            ...
            <div class="h-100 d-flex flex-column">
                ...
                <form id="bouquetCustomizationForm" class="flex-grow-1 d-flex flex-column">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3" id="wrapperGrid">
                            <?php $__currentLoopData = ($items['Wrapper'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wrap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="wrapper-option" data-wrapper="<?php echo e($wrap->name); ?>" data-price="<?php echo e($wrap->price ?? 0); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3" id="focalFlowerGrid1">
                            <?php $__currentLoopData = ($items['Focal'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $focal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="focal1-option" data-flower="<?php echo e($focal->name); ?>" data-price="<?php echo e($focal->price ?? 0); ?>">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3" id="focalFlowerGrid2">
                            <?php $__currentLoopData = ($items['Focal'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $focal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="focal2-option" data-flower="<?php echo e($focal->name); ?>" data-price="<?php echo e($focal->price ?? 0); ?>">
                                    <div class="flower-card position-relative">
                                        <div class="rounded-3" style="height: 80px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            <?php if($focal->image): ?>
                                                <img src="<?php echo e(asset('storage/'.$focal->image)); ?>" alt="<?php echo e($focal->name); ?>" style="max-height:80px; max-width:100%; object-fit:cover;">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3" id="focalFlowerGrid3">
                            <?php $__currentLoopData = ($items['Focal'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $focal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="focal3-option" data-flower="<?php echo e($focal->name); ?>" data-price="<?php echo e($focal->price ?? 0); ?>">
                                    <div class="flower-card position-relative">
                                        <div class="rounded-3" style="height: 80px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            <?php if($focal->image): ?>
                                                <img src="<?php echo e(asset('storage/'.$focal->image)); ?>" alt="<?php echo e($focal->name); ?>" style="max-height:80px; max-width:100%; object-fit:cover;">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <?php $__currentLoopData = ($items['Greeneries'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $greenery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="greenery-option" data-greenery="<?php echo e($greenery->name); ?>" data-price="<?php echo e($greenery->price ?? 0); ?>">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <?php $__currentLoopData = ($items['Fillers'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filler): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-3">
                                <div class="filler-option" data-filler="<?php echo e($filler->name); ?>" data-price="<?php echo e($filler->price ?? 0); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-3">
                                <div class="ribbon-option" data-ribbon="<?php echo e($ribbon->name); ?>" data-price="<?php echo e($ribbon->price ?? 0); ?>">
