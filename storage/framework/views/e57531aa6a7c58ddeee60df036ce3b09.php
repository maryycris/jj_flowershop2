        ...
        .then(data => {
            if (data.success && data.messages.length > 0) {
                ...
                data.messages.forEach(msg => {
                    const sender = msg.sender_id == <?php echo e(Auth::id()); ?> ? 'user' : 'support';
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/customer/chat/index.blade.php ENDPATH**/ ?>