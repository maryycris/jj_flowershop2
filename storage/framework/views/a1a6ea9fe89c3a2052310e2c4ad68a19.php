...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-2">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <select class="form-select" id="order_method_top" style="width: 160px;" onchange="if(this.value==='delivery'){window.location='<?php echo e(route('clerk.orders.walkin.delivery')); ?>';}">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="<?php echo e(route('clerk.orders.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="order_date" name="order_date" value="<?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                </div>
                ...
                <div class="mt-4 d-flex justify-content-end">
                    <a href="<?php echo e(route('clerk.orders.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.clerk_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/clerk/orders/create.blade.php ENDPATH**/ ?>