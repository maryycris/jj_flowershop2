            ...
            <form action="<?php echo e(route('admin.profile.update')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>" class="form-control" required>
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_Flowershop_Capstone\resources\views/admin/profile.blade.php ENDPATH**/ ?>