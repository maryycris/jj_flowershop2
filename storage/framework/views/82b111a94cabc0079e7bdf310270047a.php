            ...
            <div class="card shadow-sm" style="border:0;">
                <div class="card-body p-0" style="background:#fff;">
                    <div class="p-3 d-flex align-items-center gap-3" style="border-bottom:1px solid #e6f0e6;">
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm btn-outline-secondary d-inline-flex align-items-center justify-content-center" title="Back" aria-label="Back" style="width:34px;height:34px;padding:0;">
                        ...
                        <div class="ms-auto d-flex align-items-center gap-3">
                            ...
                            <a href="<?php echo e(route('admin.orders.online.validate', $order->id)); ?>" class="btn btn-sm btn-success">Validate Order</a>
