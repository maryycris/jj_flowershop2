...
<?php if(isset($pendingAcceptance) && $pendingAcceptance->count() > 0): ?>
<div class="card shadow-lg mb-4" style="border: none; border-radius: 16px; border-left: 4px solid #ffc107;">
    ...
    <div class="card-body p-0">
        <?php $__currentLoopData = $pendingAcceptance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php elseif(!isset($pendingAcceptance) || $pendingAcceptance->count() == 0): ?>
