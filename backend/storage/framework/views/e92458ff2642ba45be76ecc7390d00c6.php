                ...
                <div class="row" style="width: 100%; margin: 0 auto;">
                    ...
                    <div class="col-md-6">
                        <div class="profile-card">
                            ...
                            <hr class="profile-divider">
                            <form action="<?php echo e(route('customer.account.update_password')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php if($errors->any()): ?>
        ...
        <div class="modal-content" style="background: #ffffff;">
            ...
            <div class="modal-body" style="max-height: 60vh; overflow-y: auto;">
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="contact_number" value="<?php echo e(Auth::user()->contact_number ?? ''); ?>" required placeholder="Enter your cellphone number">
                </div>
            </div>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/customer/account/index.blade.php ENDPATH**/ ?>