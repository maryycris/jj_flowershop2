                                        ...
                                        <div class="rounded-3" style="height: 120px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center text-muted p-2">
                                                    ...
                                                    <div class="small mt-1" style="font-size: 0.65rem; line-height: 1.1;"><?php echo e($wrap->name); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="rounded-3" style="height: 120px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center text-muted p-2">
                                                    ...
                                                    <div class="small mt-1" style="font-size: 0.65rem; line-height: 1.1;"><?php echo e($focal->name); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="rounded-3" style="height: 120px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center text-muted p-2">
                                                    ...
                                                    <div class="small mt-1" style="font-size: 0.65rem; line-height: 1.1;"><?php echo e($greenery->name); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="rounded-3" style="height: 120px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center text-muted p-2">
                                                    ...
                                                    <div class="small mt-1" style="font-size: 0.65rem; line-height: 1.1;"><?php echo e($filler->name); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="rounded-3" style="height: 120px; background:#f8f9fa; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                            ...
                                            <?php else: ?>
                                                <div class="text-center text-muted p-2">
                                                    ...
                                                    <div class="small mt-1" style="font-size: 0.65rem; line-height: 1.1;"><?php echo e($ribbon->name); ?></div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/products/bouquet-customize.blade.php ENDPATH**/ ?>