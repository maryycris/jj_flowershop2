            ...
            <ul class="nav nav-tabs mb-4 notification-tabs" id="notificationTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active notification-tab-btn" id="all-tab" data-bs-toggle="tab" data-bs-target="#all-notifications" type="button" role="tab" aria-controls="all-notifications" aria-selected="true" style="color: #000 !important; font-weight: 600 !important;">
                        ...
                        <span class="badge bg-primary ms-2 notification-badge" id="all-count"><?php echo e($notifications->count()); ?></span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <div class="notification-item p-3 border-bottom <?php echo e($notification->read_at ? '' : 'bg-light'); ?>" 
                            ...
                            <div class="d-flex align-items-start notification-content-wrapper">
                                <div class="me-2 me-md-3 notification-icon-wrapper">
                                    <i class="<?php echo e($icon); ?> text-<?php echo e($color); ?> notification-icon"></i>
                                </div>
                                <div class="flex-grow-1 notification-text-wrapper">
                                    <h6 class="mb-1 notification-title-text <?php echo e($notification->read_at ? 'text-muted' : 'fw-bold'); ?>" style="font-size: 1.1rem; color: #2c3e50;">
                                        <?php echo e($title); ?>

                                    </h6>
                                    <p class="mb-1 notification-message" style="color: #555; font-size: 0.95rem; line-height: 1.4;"><?php echo e($message); ?></p>
                                    <small class="text-muted notification-time" style="font-size: 0.8rem;"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                </div>
                                <div class="d-flex align-items-center flex-column notification-actions-wrapper">
                                    <div class="d-flex align-items-center mb-1">
                                    <?php if(!$notification->read_at): ?>
                                            <div class="badge bg-<?php echo e($color); ?> rounded-pill me-2 notification-new-badge" style="font-size: 0.7rem;">New</div>
                                    <?php endif; ?>
                                    <?php if($isClickable): ?>
                                    ...
                                    <div class="dropdown notification-menu" style="position: relative;">
                                        <button class="btn btn-link text-muted p-1 notification-menu-btn" type="button" id="notificationMenu<?php echo e($notification->id); ?>" data-bs-toggle="dropdown" aria-expanded="false" onclick="event.stopPropagation();">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/customer/notifications/index.blade.php ENDPATH**/ ?>