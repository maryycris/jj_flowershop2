                    ...
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>" class="text-decoration-none">
                        <div class="card text-center h-100 pending-card">
                            <div class="card-body py-3">
                                <h3 class="text-warning mb-1"><?php echo e($pendingOrdersCount ?? 0); ?></h3>
                ...
                <div class="col-md-3">
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'approved'])); ?>" class="text-decoration-none">
                        <div class="card text-center h-100 approved-card">
                            <div class="card-body py-3">
                                <h3 class="text-info mb-1"><?php echo e($approvedOrdersCount ?? 0); ?></h3>
                ...
                <div class="col-md-3">
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'on_delivery'])); ?>" class="text-decoration-none">
                        <div class="card text-center h-100 delivery-card">
                            <div class="card-body py-3">
                                <h3 class="text-primary mb-1"><?php echo e($onDeliveryCount ?? 0); ?></h3>
                ...
                <div class="col-md-3">
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'completed', 'today' => 1])); ?>" class="text-decoration-none">
                        <div class="card text-center h-100 completed-card">
                            <div class="card-body py-3">
                                <h3 class="text-success mb-1"><?php echo e($completedTodayCount ?? 0); ?></h3>
            ...
            <div class="row mb-3 g-2">
                <div class="col-md-4">
                    <div class="card text-center h-100 revenue-card">
                        <div class="card-body py-3">
                            <h4 class="text-success mb-1">₱<?php echo e(number_format($todayRevenue ?? 0, 2)); ?></h4>
                ...
                <div class="col-md-4">
                    <div class="card text-center h-100 revenue-card">
                        <div class="card-body py-3">
                            <h4 class="text-success mb-1">₱<?php echo e(number_format($thisWeekRevenue ?? 0, 2)); ?></h4>
                ...
                <div class="col-md-4">
                    <div class="card text-center h-100 revenue-card">
                        <div class="card-body py-3">
                            <h4 class="text-success mb-1">₱<?php echo e(number_format($thisMonthRevenue ?? 0, 2)); ?></h4>
            ...
            <div class="row mb-3 g-2">
                <div class="col-md-3">
                    <div class="card text-center h-100 light-green-card">
                        <div class="card-body py-3">
                            <h4 class="mb-1"><?php echo e(number_format($totalCustomers ?? 0)); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card text-center h-100 light-green-card">
                        <div class="card-body py-3">
                            <h4 class="mb-1"><?php echo e(number_format($totalProducts ?? 0)); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card text-center h-100 light-green-card">
                        <div class="card-body py-3">
                            <h4 class="mb-1"><?php echo e(number_format($totalOrders ?? 0)); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card text-center h-100 light-green-card">
                        <div class="card-body py-3">
                            <h4 class="mb-1"><?php echo e($totalMovementsToday ?? 0); ?></h4>
            ...
            <div class="row mb-3 g-2">
                    ...
                    <div class="card light-green-card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="badge bg-primary"><?php echo e(number_format($onlineOrdersCount ?? 0)); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-shop me-2"></i>Walk-in Orders</span>
                                <span class="badge bg-info"><?php echo e(number_format($walkinOrdersCount ?? 0)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card light-green-card">
                        ...
                        <div class="card-body">
                            <?php if(isset($topProductsThisMonth) && count($topProductsThisMonth) > 0): ?>
                                <?php $__currentLoopData = $topProductsThisMonth; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                        <span><?php echo e($product->name); ?></span>
                                        <div>
                                            <span class="badge bg-success me-1"><?php echo e($product->total_sold); ?> sold</span>
                                            <span class="badge bg-secondary">₱<?php echo e(number_format($product->total_revenue, 2)); ?></span>
                                        </div>
                                    </div>
    ...
    const salesChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Revenue (₱)',
                    data: <?php echo json_encode($salesChartData ?? [], 15, 512) ?>,
                ...
                {
                    label: 'Orders Count',
                    data: <?php echo json_encode($ordersChartData ?? [], 15, 512) ?>,
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>