            ...
            <div class="row g-2 align-items-end">
                <div class="col-12">
                    <div class="input-group position-relative">
                        <input id="productSearchInput" type="text" class="form-control" placeholder="Search products..." aria-label="Search" value="<?php echo e(request('search', '')); ?>" autocomplete="off">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchSuggestions(query) {
        fetch(`<?php echo e(route('customer.search-suggestions')); ?>?q=${encodeURIComponent(query)}`)
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/customer/dashboard.blade.php ENDPATH**/ ?>