                    ...
                    <div class="bg-white rounded shadow-sm p-3">
                        ...
                        <div id="orderList">
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $order->customBouquets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customBouquet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="row order-list-row order-row clickable" 
                                        data-status="<?php echo e(\App\Services\OrderStatusService::getCustomerDisplayStatus($order->order_status ?? $order->status)); ?>"
                                        ...
                                        <div class="col-md-2 d-none d-md-flex align-items-center">₱<?php echo e(number_format($customBouquet->total_price, 2)); ?></div>
                                        <div class="col-md-2 d-none d-md-flex align-items-center">x<?php echo e($customBouquet->pivot->quantity); ?></div>
                                        <div class="col-md-2 d-none d-md-flex align-items-center"><?php echo e($order->created_at->format('M d, Y')); ?></div>
                                        <div class="col-md-2 d-none d-md-flex align-items-center justify-content-end">
                                            <?php
                                                $orderStatus = $order->order_status ?? $order->status;
                                        ...
                                        <div class="col-12 d-md-none">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <span class="text-success fw-bold">₱<?php echo e(number_format($customBouquet->total_price, 2)); ?></span>
                                                            <span class="text-muted ms-2">x<?php echo e($customBouquet->pivot->quantity); ?></span>
                                                        </div>
                                                        <div class="text-end">
                                                            <div class="text-muted small mb-1"><?php echo e($order->created_at->format('M d, Y')); ?></div>
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/customer/orders/index.blade.php ENDPATH**/ ?>