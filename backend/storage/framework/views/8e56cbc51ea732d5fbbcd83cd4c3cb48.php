                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="text-end">
                                    ...
                                    <div class="fw-bold" style="color: #28a745; font-size: 1.1rem;">₱<?php echo e(number_format($assemblingFee ?? 150, 2)); ?></div>
                                </div>
                            ...
                            <div class="col-6 col-md-2 col-lg-2 col-xl-2">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body p-2">
                                        ...
                                        <div class="text-muted small">₱<?php echo e(number_format($item->computed_price ?? ($item->inventoryItem->price ?? ($item->price ?? 0)), 2)); ?></div>
                                    </div>
                                ...
                                <form class="modal-content" method="POST" action="<?php echo e(route('admin.customize.update',$item->id)); ?>" enctype="multipart/form-data" onsubmit="handleEditForm(event, <?php echo e($item->id); ?>)">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="number" step="0.01" name="price" id="itemPriceEdit<?php echo e($item->id); ?>" class="form-control" readonly value="<?php echo e($item->inventoryItem ? $item->inventoryItem->price : ($item->price ?? 0)); ?>">
...
<div class="modal fade" id="assemblingFeeModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <form class="modal-content" method="POST" action="<?php echo e(route('admin.customize.update-assembling-fee')); ?>" onsubmit="handleAssemblingFeeForm(event)">
      <?php echo csrf_field(); ?>
      ...
      <div class="modal-body">
        <div class="mb-3">
          ...
          <input type="number" step="0.01" name="assembling_fee" id="assemblingFeeInput" class="form-control" value="<?php echo e($assemblingFee ?? 150); ?>" min="0" required>
...
<?php echo $__env->make('layouts.admin_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/admin/customize/index.blade.php ENDPATH**/ ?>