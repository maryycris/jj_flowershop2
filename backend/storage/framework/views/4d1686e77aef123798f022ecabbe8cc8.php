...
<div class="navbar-admin">
    <div class="navbar-admin-content">
        ...
        <div class="d-flex align-items-center gap-3">
            <!-- Notifications Icon -->
            <a href="<?php echo e(route('admin.notifications.index')); ?>" class="text-white text-decoration-none <?php if(request()->routeIs('admin.notifications.*')): ?> active <?php endif; ?>" title="Notifications">
                <i class="bi bi-bell fs-5"></i>
            </a>
            
            <!-- Chat Icon -->
            <a href="<?php echo e(route('admin.chatbox')); ?>" class="text-white text-decoration-none <?php if(request()->routeIs('admin.chatbox')): ?> active <?php endif; ?>" title="Chat">
            ...
            <div class="admin-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="adminProfileDropdown">
                    ...
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.users.index')); ?>">Manage Accounts</a></li>
...
<div class="navbar-admin-links-row">
    <div class="navbar-admin-links">
        ...
        <a href="<?php echo e(route('invoices.index')); ?>" class="nav-link <?php if(request()->routeIs('invoices.*')): ?> active <?php endif; ?>"><i class="bi bi-receipt"></i> Invoices</a>
        <a href="<?php echo e(route('admin.sales-orders.index')); ?>" class="nav-link <?php if(request()->routeIs('admin.sales-orders.*') || request()->routeIs('admin.orders.index')): ?> active <?php endif; ?>"><i class="bi bi-cart"></i> Sales Orders</a>
        <a href="<?php echo e(route('admin.reports.sales')); ?>" class="nav-link <?php if(request()->routeIs('admin.reports.sales')): ?> active <?php endif; ?>"><i class="bi bi-graph-up"></i> Sales Report</a>
        <a href="<?php echo e(route('admin.loyalty.index')); ?>" class="nav-link <?php if(request()->routeIs('admin.loyalty.*')): ?> active <?php endif; ?>"><i class="bi bi-gift"></i> Loyalty Cards</a>
...
<?php endif; ?>
<div class="container-fluid <?php if(!request()->routeIs('admin.sales-orders.*')): ?> <?php if(request()->routeIs('invoices.*')): ?> pt-1 pb-4 <?php else: ?> py-4 <?php endif; ?> <?php endif; ?>" style="padding-left: 4.0vw; padding-right: 4.0vw;">
    <?php if(session('success')): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/layouts/admin_app.blade.php ENDPATH**/ ?>