                    ...
                    <div class="purchase-summary-header mb-3">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <?php else: ?>
                                ...
                                <img src="<?php echo e($item->product->image_url ?? asset('images/logo.png')); ?>" 
                                     style="width: 54px; height: 54px; object-fit: cover; border-radius: 8px;"
                                     alt="<?php echo e($item->product->name); ?>"
                                     onerror="this.onerror=null; this.src='<?php echo e(asset('images/logo.png')); ?>'; this.style.opacity='0.5';">
                                <div class="flex-grow-1 ms-2">
...
<?php echo $__env->make('layouts.customer_app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/customer/checkout/index.blade.php ENDPATH**/ ?>