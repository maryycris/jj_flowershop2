...
<body>
    <div class="mobile-topbar d-flex align-items-center justify-content-between">
        ...
        <div>
            <a href="<?php echo e(route('customer.cart.index')); ?>" class="icon-btn me-2"><i class="bi bi-cart"></i></a>
            <a href="<?php echo e(route('login')); ?>" class="icon-btn"><i class="bi bi-person"></i></a>
        </div>
    </div>
    <?php if(isset($headerLabel)): ?>
        <div class="mobile-header-label"><?php echo e($headerLabel); ?></div>
    <?php endif; ?>
...
</html> <?php /**PATH C:\xampp\htdocs\JJ_FLOWERSHOP CAPSTONE\backend\../frontend/resources/views/layouts/mobile_app.blade.php ENDPATH**/ ?>