...
<head>
    ...
    <style>
        ...
        #products .products-bg { position: absolute; top: -60px; left: 0; right: 0; height: 625px; background-image: url('/images/productsbg.jpg'); background-size: cover; background-position: center top; z-index: 0; pointer-events: none; filter: blur(1px) opacity(0.95); transform: scale(1.06); }
