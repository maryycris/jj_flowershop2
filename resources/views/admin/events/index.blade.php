                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ route('admin.events.invoice.view', $event->id) }}" class="btn btn-sm btn-outline-secondary" target="_blank" title="View Invoice">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Admin Events Dashboard loaded');
});
</script>
