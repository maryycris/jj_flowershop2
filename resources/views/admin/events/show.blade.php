                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="statusForm" method="POST" action="{{ route('admin.events.updateStatus', $event) }}">
                                        @csrf
                                        <div class="mb-3">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('admin.events.invoice.view', $event->id) }}" class="btn btn-outline-secondary btn-sm" target="_blank">
                                            <i class="bi bi-eye"></i> View Invoice
                                        </a>
                                        <a href="{{ route('admin.events.invoice.download', $event->id) }}" class="btn btn-outline-dark btn-sm">
