        ...
        <div class="col pt-4">
            ...
            <div class="row g-4 mb-3 align-items-stretch">
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.orders.index', ['status' => 'pending']) }}" style="text-decoration: none; color: inherit;">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.orders.index', ['status' => 'approved']) }}" style="text-decoration: none; color: inherit;">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.orders.index', ['status' => 'on_delivery']) }}" style="text-decoration: none; color: inherit;">
                ...
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('admin.orders.index', ['status' => 'completed', 'today' => 1]) }}" style="text-decoration: none; color: inherit;">
                        ...
                        <div id="popularProductsList" style="max-height: 180px; overflow-y: auto;">
                            @if(!empty($popularProducts) && count($popularProducts))
                                @foreach($popularProducts as $p)
                                    <div class="d-flex justify-content-between small"><span>{{ $p->name }}</span><span class="text-muted">x{{ $p->total_quantity }}</span></div>
                                @endforeach
                            @else
