                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $events->where('status', 'pending')->count() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $events->where('status', 'confirmed')->count() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $events->where('status', 'completed')->count() }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                @else
                                    <span class="text-muted">EVT-{{ str_pad($event->id, 6, '0', STR_PAD_LEFT) }}</span>
                                @endif
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-{{ $event->event_type === 'wedding' ? 'heart-fill' : ($event->event_type === 'birthday' ? 'cake2-fill' : ($event->event_type === 'funeral' ? 'flower1' : 'gift-fill')) }} me-2 text-success"></i>
                            ...
                            <td>
                                <div>
                                    <strong>{{ $event->user->name ?? 'N/A' }}</strong>
                                    @if($event->user->email)
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('clerk.events.show', $event) }}" class="btn btn-sm btn-outline-primary" title="View Details">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#" onclick="updateStatus({{ $event->id }}, 'confirmed')">
                                                <i class="bi bi-check-circle text-info me-2"></i>Confirm
                                            </a></li>
                                            <li><a class="dropdown-item" href="#" onclick="updateStatus({{ $event->id }}, 'completed')">
                                                <i class="bi bi-check-circle-fill text-success me-2"></i>Complete
                                            </a></li>
                                            <li><a class="dropdown-item" href="#" onclick="updateStatus({{ $event->id }}, 'cancelled')">
                                                <i class="bi bi-x-circle text-danger me-2"></i>Cancel
                                            </a></li>
                                        </ul>
                                    </div>
                                    <a href="{{ route('clerk.events.invoice.view', $event->id) }}" class="btn btn-sm btn-outline-secondary" target="_blank" title="View Invoice">
