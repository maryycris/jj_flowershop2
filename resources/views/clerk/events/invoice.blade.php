...
<head>
    <meta charset="UTF-8">
    <title>Event Invoice - Clerk</title>
    <style>
...
<div class="invoice-box">
    <div class="header">
        <h1>JJ Flowershop <span class="clerk-badge">CLERK</span></h1>
    ...
    <div style="margin-top: 40px; text-align: center; color: #6c757d; font-size: 14px;">
        <p><strong>CLERK COPY</strong></p>
        <p>Event ID: {{ $event->id }} | Generated: {{ now()->format('Y-m-d H:i:s') }}</p>
        <p>For inquiries, please contact us at: <strong>+63 XXX XXX XXXX</strong></p>
        <p>Email: <strong>clerk@jjflowershop.com</strong></p>
    </div>
</div>
</body>
</html>
