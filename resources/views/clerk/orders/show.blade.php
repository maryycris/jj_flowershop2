                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="recipient_name" value="{{ $order->delivery ? $order->delivery->recipient_name : '' }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Recipient Phone</label>
                            <input type="text" class="form-control" name="recipient_phone" value="{{ $order->delivery ? $order->delivery->recipient_phone : '' }}" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="delivery_address" rows="3" required>{{ $order->delivery ? $order->delivery->delivery_address : '' }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Special Instructions</label>
                            <textarea class="form-control" name="special_instructions" rows="2" placeholder="Any special delivery instructions...">{{ $order->delivery ? $order->delivery->special_instructions : '' }}</textarea>
                        </div>
                    </div>
                </div>
                
                <!-- Enhanced Recipient Information Display -->
                @if($order->delivery && ($order->delivery->delivery_message || $order->delivery->recipient_relationship))
                <div class="row mt-3">
                    <div class="col-12">
                        <div class="alert alert-info">
                            ...
                            @if($order->delivery && $order->delivery->delivery_message)
                                <div class="mb-2">
                                    <strong>Delivery Message:</strong>
                                    <p class="mb-0 mt-1">{{ $order->delivery->delivery_message }}</p>
                                </div>
                            @endif
                            @if($order->delivery && $order->delivery->recipient_relationship)
                                <div>
