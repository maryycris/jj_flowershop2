                ...
                <div class="mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="occasion-option" data-occasion="{{ $occasion->slug }}" data-theme="{{ $occasion->color_theme }}" data-flowers="{{ json_encode($occasion->recommended_flowers) }}" data-wrappers="{{ json_encode($occasion->recommended_wrappers) }}" data-ribbons="{{ json_encode($occasion->recommended_ribbons) }}" data-base-price="{{ $occasion->base_price }}">
                                <div class="occasion-card position-relative">
                                    <div class="rounded-3" style="height: 100px; background: linear-gradient(135deg, {{ $occasion->color_theme === 'White' ? '#f8f9fa, #e9ecef' : ($occasion->color_theme === 'Red & Pink' ? '#ff6b6b, #ff9ff3' : ($occasion->color_theme === 'Bright Colors' ? '#ffd700, #ff6b6b, #4ecdc4' : '#ff9ff3, #f8f9fa')) }}); display: flex; align-items: center; justify-content: center; border: 2px solid transparent; transition: all 0.3s ease;">
                                        <div class="text-center">
                                            <i class="bi bi-{{ $occasion->slug === 'funeral' ? 'flower1' : ($occasion->slug === 'birthday' ? 'gift' : ($occasion->slug === 'wedding' ? 'heart' : ($occasion->slug === 'valentines' ? 'heart-fill' : ($occasion->slug === 'anniversary' ? 'gem' : ($occasion->slug === 'get-well' ? 'bandaid' : ($occasion->slug === 'graduation' ? 'mortarboard' : 'flower2')))))) }} fs-2 text-white"></i>
                                            <div class="fw-bold text-white small mt-1">{{ $occasion->name }}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="occasion-info mt-2 text-center">
                                        <small class="fw-medium text-dark">{{ $occasion->description }}</small>
                                        <div class="text-success fw-bold small">From ₱{{ number_format($occasion->base_price, 0) }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<hr class="my-4">
                ...
                <form id="bouquetCustomizationForm" class="flex-grow-1 d-flex flex-column">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3" id="wrapperGrid">
                            @foreach(($items['Packaging Materials'] ?? []) as $wrap)
                            <div class="col-3">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            @foreach(($items['Dried Flowers'] ?? []) as $greenery)
                            <div class="col-3">
                ...
                <hr class="my-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            @foreach(($items['Floral Supplies'] ?? []) as $ribbon)
                            <div class="col-3">
