                ...
                <div class="bg-white rounded-3 p-3 p-md-4 mb-3 mb-lg-4 scrollable-content order-details-card" style="box-shadow: 0 4px 20px rgba(0,0,0,0.08); border: none; overflow-y: auto;">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0 small">Order #{{ $order->id }} • {{ $order->created_at->format('M d, Y') }}</p>
                </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-2" style="background: #f8f9fa; border-radius: 6px;">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <span class="badge bg-{{ $statusColor }} px-2 py-1" style="font-size: 0.7rem;">{{ $statusDisplay }}</span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <strong class="text-dark">{{ ucwords(str_replace('_', ' ', $order->refund_method)) }}</strong>
                                            </div>
                                            <div class="col-md-4">
                                                <small class="text-muted d-block">Processed Date</small>
                                                <strong class="text-dark">
                                                    @if($order->refund_processed_at)
                                                        {{ $order->refund_processed_at instanceof \Carbon\Carbon ? $order->refund_processed_at->format('M d, Y g:i A') : \Carbon\Carbon::parse($order->refund_processed_at)->format('M d, Y g:i A') }}
                                                    @else
                                                        N/A
                                                    @endif
                                                </strong>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <span class="text-dark">{{ $order->refund_reason }}</span>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-2" style="background: linear-gradient(135deg, #8ACB88, #7bb47b); border-radius: 6px; color: white;">
                                ...
                                <div>
                                    ...
                                    <strong style="font-size: 1rem;">₱{{ number_format($order->total_price, 2) }}</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-2" style="background: #f8f9fa; border-radius: 6px;">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-info px-2 py-1" style="font-size: 0.7rem;">{{ strtoupper($order->payment_method ?? 'N/A') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center p-2" style="background: #f8f9fa; border-radius: 6px; border-left: 3px solid #8ACB88;">
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h6 class="mb-1" style="color: #2c3e50; font-size: 0.9rem;">{{ $product->name }}</h6>
                                            <small class="text-muted" style="font-size: 0.75rem;">Quantity: {{ $product->pivot->quantity }}</small>
                                        </div>
                                        <div class="text-end">
                                            <strong style="color: #8ACB88; font-size: 0.9rem;">₱{{ number_format($product->price * $product->pivot->quantity, 2) }}</strong>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center p-2" style="background: #f8f9fa; border-radius: 6px;">
                                        ...
                                        <div>
                                            ...
                                            <strong style="font-size: 0.85rem;">{{ $order->delivery->recipient_name ?? 'N/A' }}</strong>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-center p-2 mb-2" style="background: #f8f9fa; border-radius: 6px;">
                            ...
                            <div>
                                ...
                                <strong style="font-size: 0.85rem;">{{ $order->user->email }}</strong>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-2" style="background: #f8f9fa; border-radius: 6px;">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small text-muted">
                                        ...
                                        @if($order->completed_at)
                                            Received on: {{ $order->completed_at->format('M d, Y g:i A') }}
                                        @endif
                                    </p>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="mb-3">
                    <img src="/storage/{{ $order->delivery->proof_of_delivery_image }}" 
            ...
            <div class="modal-footer">
                ...
                <a href="/storage/{{ $order->delivery->proof_of_delivery_image }}" 
                   target="_blank" 
