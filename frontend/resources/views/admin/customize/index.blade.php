...
@media (max-width: 450px) {
    ...
    /* Assembling Fee Card - Smaller */
    .assembling-fee-card h6 {
        font-size: 0.75rem !important;
    }
    .assembling-fee-card small {
        font-size: 0.65rem !important;
    }
    .assembling-fee-card .form-label {
        font-size: 0.7rem !important;
    }
    .assembling-fee-card .fw-bold {
        font-size: 0.9rem !important;
    }
    .assembling-fee-card .bi-pencil-square {
        font-size: 1rem !important;
    }
    .assembling-fee-card .bi-currency-exchange {
    ...
    .customize-scroll-container .action-btn i {
        font-size: 0.65rem !important;
    }
