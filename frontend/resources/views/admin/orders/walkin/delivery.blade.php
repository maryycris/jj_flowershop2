...
<div class="pt-2 pb-4" style="background: #f4faf4; min-height: 100vh;">
  <div class="container" style="max-width: 1400px;">
    <form action="{{ route('admin.orders.store') }}" method="POST" id="walkinDeliveryForm">
      @csrf
      ...
      <div class="row justify-content-center mt-2">
        <div class="col-12 col-lg-8">
          <div class="bg-white rounded-3 p-3 mb-4" style="box-shadow: none;">
            ...
            <div class="mb-3">
              <a href="{{ route('admin.orders.index') }}" class="btn btn-outline-success">&larr; Back</a>
            </div>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  orderMethodSelect?.addEventListener('change', function(){
    if (this.value === 'pickup') {
      window.location = "{{ route('admin.orders.create') }}";
    } else {
      window.location = "{{ route('admin.orders.walkin.delivery') }}";
    }
  });
