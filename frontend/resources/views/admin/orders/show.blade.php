                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Contact:</strong> 
                                                @if($order->delivery && $order->delivery->recipient_phone)
                                                    {{ $order->delivery->recipient_phone }}
                                                @elseif($order->user->contact_number)
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Delivery Address:</strong> 
                                                ...
                                                @elseif($order->delivery->recipient_name)
                                                    {{ $order->delivery->recipient_name }} - Address not specified
                                                @else
                                                    N/A
                                                @endif
                                            </p>
                                            @if($order->delivery->recipient_name)
                                                <p><strong>Recipient:</strong> {{ $order->delivery->recipient_name }}</p>
                                            @endif
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{ route('admin.orders.invoice.view', $order->id) }}" class="btn btn-primary btn-sm mb-2 w-100" target="_blank">
                                        <i class="fas fa-eye"></i> View {{ $isOnDelivery ? 'Invoice' : 'Order Slip' }}
                                    </a>
                                    <a href="{{ route('admin.orders.invoice.download', $order->id) }}" class="btn btn-success btn-sm w-100">
